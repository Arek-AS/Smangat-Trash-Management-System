...
def input_data_sampah():
    while True:
        ...
        kelas_apa = int(input())
        if 1 <= kelas_apa <= 3: break
        print(f"{MERAH}PILIHAN TIDAK TERSEDIA, MOHON MASUKKAN ANGKA 1-3!{RESET}")
    while True:
        tampilkan_data_kelas(kelas_apa)
        jenis_kelas = int(input())
        if 1 <= jenis_kelas <= 12: break
        print(f"{MERAH}PILIHAN TIDAK TERSEDIA, MOHON MASUKKAN ANGKA 1-12!{RESET}")
    while True:
        tampilkan_menu_sampah()
        jenis_sampah = int(input())
        if 1 <= jenis_sampah <= 3: break
        print(f"{MERAH}PILIHAN TIDAK TERSEDIA, MOHON MASUKKAN ANGKA 1-3!{RESET}")
...
def cek_statistik_sampah():
    ...
    while True:
        opsi = int(input())
        if opsi in [1,2]: break
        print(f"{MERAH}PILIHAN TIDAK TERSEDIA, MOHON MASUKKAN ANGKA 1 ATAU 2!{RESET}")
    if opsi == 1:
...
def main():
    while True:
        print(f"{HIJAU}=============   SMANGAT TRASH MANAGEMENT SYSTEM ============ {RESET}")
        print("============================================================")
        ...
        if s == 1:
            ...
            print(f"{MERAH}PILIHAN TIDAK TERSEDIA, MOHON MASUKKAN ANGKA 1-5!{RESET}\n")
